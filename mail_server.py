...
def save_mail(mail: List[Dict[str, str]]) -> None:
    ...
    This function saves mail to a file named "mail_db.json" by concatenating it 
    with information already found in mail_dj.json.
    
    Arguments: list of dictionaries representing mail entries 
...
def add_mail(mail_entry: Dict[str, str]) -> str:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    This function adds mail to a dictionary.
    
    Arguments: list of dictionaries representing mail entries
    
    Returns: a string of the mail file added to the mail dictionary
    """
    mail = load_mail()
...
def delete_mail(mail_id: str) -> bool:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    This function deletes a mail entry at a specified location
    
    Arguments: string of mail_id to delete
...
def get_mail(mail_id: str) -> Optional[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    This function loads a mail_id and returns the specified dictionary entry.
    
    Arguments: a mail_id string
    
    Returns: the dictionary entry of the specified mail
    """
    mail = load_mail()
    for entry in mail:
        if entry['id'] == mail_id:
...
def get_inbox(recipient: str) -> List[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    This function takes new mail from the load_mail function and adds it to the
    inbox array as a dictionary entry.
    
    Arguments: a string representing the recipient 
    
    Returns: dictionary entry with the new mail appended to the inbox
    """
    mail = load_mail()
    inbox = []
    for entry in mail:
...
def get_sent(sender: str) -> List[Dict[str, str]]:
    """TODO: fill out this docstring (using the load_mail docstring as a guide)
    This function takes mail from a sender and adds it to the sent "folder" (really
    an array) in mail. 
    
    Arguments: a string representing the sender's name
    
    Returns: dictionary entry with the sent mail
    """
    mail = load_mail()
    sent = []
    for entry in mail:
...
def get_sent_route(sender: str):
    ...
    Args: sender (str): The sender of the mail
    
    Returns: a list of dictionaries representing the mail entries
    """
